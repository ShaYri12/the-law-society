...
export const SearchResults = ({ results }) => {
  ...
  // Assuming we're displaying the first result for simplicity
  const solicitor = results[0];
          ...
          <div key={index}>
            ...
            <div
              className={`border-t border-[#4D839C] border-l-[4px] transition-all duration-300 ease-in-out ${
                openSections.areas ? "border-l-[#004d71]" : "border-l-white"
              }`}
            >
              <button
            ...
            <div
              className={`border-y border-[#4D839C] border-l-[4px] transition-all duration-300 ease-in-out ${
                openSections.languages ? "border-l-[#004d71]" : "border-l-white"
              }`}
            >
              <button
      ...
      <div className="max-w-[1200px] mx-auto bg-[#F2F6F8] p-[16px] border border-[#004d71] border-l-[4px] space-y-[28px] mt-[56px]">
        <div className="flex flex-col items-start">
          ...
          <p className="text-[16px] md:text-[18px] text-[16px] leading-[1.5em]">
            Most information on this page comes from the Solicitors Regulation
            Authority. However, some information may have been edited directly
            by the professional, firm or their representative.{" "}
        ...
        <div className="flex flex-col items-start">
          ...
          <p className="text-[16px] md:text-[18px] text-[16px] leading-[1.5em]">
            If you need to amend any information about you on Find a Solicitor
            or wish to give other feedback about the website, please call 020
            7320 5757 (Monday to Friday from 09:00 to 17:00 charged at local
            call rates) or visit our{" "}
            <Link to="#" className="text-[#574840] text-underline">
              contact us
            </Link>{" "}
            page.
